...
namespace Dypsloom.RhythmTimeline.Core.Playables
{
    ...
    public class RhythmTrack : TrackAsset
    {
        ...
        protected List<RhythmClip> m_TrackRhythmClips = new List<RhythmClip>();
        ...
        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            ...
            foreach (var clip in m_Clips)
            {
                ...
                m_TrackRhythmClips.Add(rhythmClip);
            }
            m_RhythmDirector.RegisterRhythmClips(m_ID,m_TrackRhythmClips);
